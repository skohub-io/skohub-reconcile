...
import { getURLParameters, getLocalizedString, knownProblemHandler, errorHandler } from './utils.js';
...
export default async function preview(req, res) {
  ...
  try {
    ...
    if (esQuery.responses[0].hits.total.value == 0) {
      knownProblemHandler(res, { code: 404, message: 'Sorry, nothing at this url.' });
    }
    // @ts-ignore
