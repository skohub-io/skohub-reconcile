...
export function esToRec (doc, prefLang, threshold) {
  ...
  let obj = {
    ...
    'name': getLocalizedString(concept.prefLabel, prefLang) || getLocalizedString(concept.title, prefLang),
    'description': getLocalizedString(concept.scopeNote, prefLang) || getLocalizedString(concept.description, prefLang) || "",
    'score': doc._score,
